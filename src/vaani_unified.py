...
print(
    "\nVaani Unified Assistant is ready."
)

startup_greetings = [
    "Welcome back, Boss! How are you today? What can I do for you?",
    "Hey Boss! Welcome back. I'm ready to help. What would you like to do today?",
    "Welcome back, Boss! It's great to have you here. How can I assist you today?",
    "Hello Boss! Vaani is online and ready. What can I do for you?",
    "Hey Boss! Good to have you back. What shall we work on today?",
    "Welcome back, Boss! I'm all set. Just tell me what you need.",
    "Hi Boss! Vaani is ready for you. How are you doing today?",
]

import random

speak(
    random.choice(startup_greetings)
)
